...
module Gram = Struct.Grammar.Static.Make Lexer Sig.OCamlSpecificError;
...
module MakeGram (Lexer : Sig.Lexer) = Struct.Grammar.Static.Make Lexer Sig.OCamlSpecificError;
