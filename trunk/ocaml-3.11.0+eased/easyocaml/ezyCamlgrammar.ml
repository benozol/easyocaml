...
module Restrict (Spec: sig value spec : EzyFeatures.program_feats; end) (Syntax: Sig.Camlp4Syntax) : sig end = struct
  ...
  do {
    ...
    DELETE_RULE Gram expr: "{<"; field_expr_list; ">}" END;
    ...
    match spec.pr_struct_feats.s_type with
      [ Some type_spec ->
          do {
            ...
            DELETE_RULE Gram type_kind: ctyp; "="; "{"; label_declaration_list; "}" END;
            ...
            match type_spec.t_record with
              [ None -> 
                  DELETE_RULE Gram type_kind: "{"; label_declaration_list; "}" END
