...
module Make_options (F :
   sig
     ...
     val _easytyping : unit -> unit
     val _easyerrorprinter : string -> unit
     val _easy_dot_type_graph : unit -> unit
     val _easylevel : string -> unit
     val _easyteachpack : string -> unit
...
struct
  let list = [
    ...
    "-easyteachpack", Arg.String F._easyteachpack, " Add a teachpack";
